...
const string PATH = "C:/Users/KCY/Documents/대학/멀티미디어 정보처리/hw1/Source/";
const string FILE_NAME[] = {"Baboon.BMP", "color bar_.bmp", "FRUIT.BMP", "lya-lc.bmp", "lya-lc-bright.bmp", "lya-lc-dark.bmp", "lya-lc-안되는예.bmp", "RGB_Colorcube_Corner_White.bmp", "지문-gray.bmp"};
